...
int main(int argc, char **argv)
{
    ...
    joint_publishers.push_back(
        n.advertise<std_msgs::Float64>("shoulder_pan_controller/intermediate_command", 5)
    );
    joint_publishers.push_back(
    ...
    //Listen from pos_for_IK
    ros::Subscriber sub = n.subscribe("pos_for_IK", 100, getPosition);
    ...
    if (found_ik)
    {
        ...
        ros::Publisher shoulder_pitch_pub = n.advertise<std_msgs::Float64>("shoulder_pitch_controller/intermediate_command", 100);
