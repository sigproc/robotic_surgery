...
req.group_name = "Arm";
moveit_msgs::Constraints pose_goal = kinematic_constraints::constructGoalConstraints("effector_tip_link", pose, tolerance_pose, tolerance_angle);
...
moveit_msgs::Constraints pose_goal_2 = kinematic_constraints::constructGoalConstraints("effector_tip_link", pose, tolerance_pose, tolerance_angle);
/* First, set the state in the planning scene to the final state of the last plan */
robot_state.setJointGroupPositions(joint_model_group, response.trajectory.joint_trajectory.points.back().positions);
...
req.path_constraints = kinematic_constraints::constructGoalConstraints("effector_tip_link", quaternion);
