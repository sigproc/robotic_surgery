...
def plot(): 
    ...
    inverse kinematics such that given the mouse (x, z) position it 
    finds the appropriate joint angles to reach that point."""

    # create an instance of the arm
    arm = Arm.Arm3Link(L = np.array([105,170,230]))

    # make our window for drawin'
    window = pyglet.window.Window()

    label = pyglet.text.Label('Mouse (x,z)', font_name='Times New Roman', 
