...
left_image_points = np.load('calibration_data/left_image_points', mmap_mode='r')
right_image_points = np.load('calibration_data/right_image_points', mmap_mode='r')
...
np.save('calibration_data/left_undistortion', left_undistortion)
np.save('calibration_data/left_rectification', left_rectification)
np.save('calibration_data/right_undistortion', right_undistortion)
np.save('calibration_data/right_rectification', right_rectification)
